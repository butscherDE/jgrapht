...
- **version 1.3.1** (3-Jun-2019):
    ...
    - Added JSON graphExporter and graphImporter (contributed by Dimitrios Michail)
...
- **version 1.3.0** (12-Nov-2018):
    ...
    - Added graphExporter for the Lemon (LGF) format (contributed by Dimitrios Michail)
...
- **version 1.0.1** (16-Jan-2017):
    ...
    - Fixed GraphML graphImporter xsd resolution bug (contributed by Dimitrios Michail, spotted by Peter Manning Jr.)
...
- **version 1.0.0** (19-Sept-2016):
    ...
    - DOT graphImporter id fix (contributed by Dimitrios Michail)
